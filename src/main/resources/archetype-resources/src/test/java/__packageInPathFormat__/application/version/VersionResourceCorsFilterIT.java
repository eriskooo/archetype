 ...
 */
package ${package}.application.version;

import ${package}.application.JaxRsActivator;
import ${package}.infrastructure.domain.value.AbstractValueObject;
import ${package}.infrastructure.rest.filter.CustomCorsFilter;
import ${package}.infrastructure.rest.jwt.JwtAuthorizationFilter;
import ${package}.infrastructure.rest.jwt.JwtClaims;
import ${package}.infrastructure.user.AuthenticatedUser;
